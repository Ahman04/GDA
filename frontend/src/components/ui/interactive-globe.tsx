...
const DEFAULT_MARKERS = [
  ...
  { lat: 9.02, lng: 38.75, label: "Addis Ababa" },
  { lat: 2.04, lng: 45.34, label: "Somalia" },
];

const DEFAULT_CONNECTIONS: { from: [number, number]; to: [number, number] }[] = [
  { from: [-1.29, 36.82], to: [25.2, 55.27] },
  { from: [-1.29, 36.82], to: [43.65, -79.38] },
  { from: [-1.29, 36.82], to: [9.02, 38.75] },
  { from: [-1.29, 36.82], to: [2.04, 45.34] },
  { from: [25.2, 55.27], to: [9.02, 38.75] },
  { from: [9.02, 38.75], to: [2.04, 45.34] },
];
...
export { Component as InteractiveGlobe };
